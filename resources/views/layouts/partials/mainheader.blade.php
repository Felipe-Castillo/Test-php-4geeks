<nav>
        <div class="menu nav-wrapper">
            ...
            <form style="margin-top: -5px" id="buscador" class="brand-logo col s8 m7 l6 xl6">
              <div class="row">
                <div class="col s12 m12 l7 xl7">
                      ...
                      <input type="hidden" name="ciudadBar" value="" id="inputBar">
                </div>
                <div class="col m6 l3 xl3">

                  <select class="menu-select browser-default" id="ciudadesBar">
                    

                  </select>
                </div>
                <div class="col l1 xl2">
            ...
            <ul id="slide-out" class="side-nav">
                ...
                <li><a href="#!"><i class="material-icons">refresh</i> Renovar <span style="font-size:13px;font-weight:normal;">@if(isset($subscription_ends_on))(Expira {{$subscription_ends_on}})
                ...
                <li><a href="{{url('/reservation')}}"><i class="material-icons">folder</i>Reservaciones</a></li>
                @else
                <li><a href="{{url('/reservacion-usuario')}}"><i class="material-icons">folder</i>Reservaciones</a></li> 
